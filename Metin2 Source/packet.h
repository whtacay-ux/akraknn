...
enum
{
	...
	CHESS_SUBHEADER_CG_ACCEPT,
	CHESS_SUBHEADER_CG_DECLINE,
	CHESS_SUBHEADER_CG_MOVE,
	CHESS_SUBHEADER_CG_QUIT,
	CHESS_SUBHEADER_CG_START_BOT,

	CHESS_SUBHEADER_GC_INVITE = 0,
	CHESS_SUBHEADER_GC_START,
	CHESS_SUBHEADER_GC_MOVE,
	CHESS_SUBHEADER_GC_END,
	CHESS_SUBHEADER_GC_UPDATE,
};

typedef struct SPacketCGChess
{
	BYTE	header;
	BYTE	subheader;
	DWORD	arg1;
