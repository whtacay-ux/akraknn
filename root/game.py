...
class GameWindow(ui.ScriptWindow):
	...
	def __Chess_OnInvite(self, name):
		self.interface.GetChessWindow().OnInvite(name)

	def __Chess_OnStart(self, is_bot, is_white, opponent_name):
	...
	def __Chess_OnEnd(self):
		self.interface.GetChessWindow().ResetGame()
		self.interface.GetChessWindow().Close()
